...
var town141000 = [
		...
		//临汾市 ok_zhangjing;
var town142300 = [
		{code:'142301',name:'孝义市'},
		{code:'142302',name:'离石区'},
		{code:'142303',name:'汾阳市'},
		{code:'142322',name:'文水县'},
		{code:'142323',name:'交城县'},
		{code:'142325',name:'兴县'},
		{code:'142326',name:'临县'},
		{code:'142327',name:'柳林县'},
		{code:'142328',name:'石楼县'},
		{code:'142329',name:'岚县'},
		{code:'142330',name:'方山县'},
		{code:'142332',name:'中阳县'},
		{code:'142333',name:'交口县'}];
		//吕梁地区 ok_zhangjing;
var town150100 = [
...
var town150200 = [
		...
		{code:'150203',name:'昆都伦区'},
		{code:'150204',name:'青山区'},
		{code:'150205',name:'石拐区'},
		{code:'150206',name:'白云矿区'},
...
var town152100 = [
		...
		{code:'152101',name:'海拉尔区'},
		{code:'152102',name:'满洲里市'},
		{code:'152103',name:'扎兰屯市'},
		{code:'152104',name:'牙克石市'},
		{code:'152105',name:'根河市'},
		{code:'152106',name:'额尔古纳市'},
		{code:'152122',name:'阿荣旗'},		
		{code:'152123',name:'莫力达瓦达斡尔族自治旗'},
		{code:'152127',name:'鄂伦春自治旗'},
		{code:'152128',name:'鄂温克族自治旗'},
		{code:'152129',name:'新巴尔虎右旗'},
		{code:'152130',name:'新巴尔虎左旗'},
		{code:'152131',name:'陈巴尔虎旗'}];
		//呼伦贝尔盟 ok_zhangjing;
...
var town152600 = [
		...
		{code:'152601',name:'集宁区'},
		{code:'152602',name:'丰镇市'},
		{code:'152624',name:'卓资县'},
		{code:'152625',name:'化德县'},
		{code:'152626',name:'商都县'},
		{code:'152627',name:'兴和县'},
		{code:'152629',name:'凉城县'},
		{code:'152630',name:'察哈尔右翼前旗'},
		{code:'152631',name:'察哈尔右翼中旗'},
		{code:'152632',name:'察哈尔右翼后旗'},
		{code:'152634',name:'四子王旗'}];
		//乌兰察布盟 ok_zhangjing;
		
var town152700 = [
		
		{code:'152701',name:'东胜区'},
		{code:'152722',name:'达拉特旗'},
		{code:'152723',name:'准格尔旗'},
		{code:'152724',name:'鄂托克前旗'},
		{code:'152725',name:'鄂托克旗'},
		{code:'152726',name:'杭锦旗'},
		{code:'152727',name:'乌审旗'},
		{code:'152728',name:'伊金霍洛旗'}];
		//鄂尔多斯市 ok_zhangjing;


var town152800 = [
		
		{code:'152801',name:'临河市'},
		{code:'152822',name:'五原县'},
		{code:'152823',name:'磴口县'},
		{code:'152824',name:'乌拉特前旗'},
		{code:'152825',name:'乌拉特中旗'},
		{code:'152826',name:'乌拉特后旗'},
		{code:'152827',name:'杭锦后旗'}];
		//巴彦淖尔盟 ok_zhangjing;
var town152900 = [
...
var town310200 = [
		...
		{code:'310225',name:'南汇县'},
		{code:'310226',name:'奉贤县'},
...
var town330100 = [
		...
		{code:'330181',name:'萧山市'},
		{code:'330182',name:'建德市'},
		{code:'330183',name:'富阳市'},
		{code:'330184',name:'余杭市'},
...
var town340100 = [
		...
		{code:'340102',name:'东市区'},
		{code:'340103',name:'中市区'},
		{code:'340104',name:'西市区'},
		{code:'340111',name:'340111'},
...
var town340200 = [
		...
		{code:'340203',name:'马塘区'},
		{code:'340204',name:'新芜区'},
...
var town340300 = [
		...
		{code:'340302',name:'东市区'},
		{code:'340303',name:'中市区'},
		{code:'340304',name:'西市区'},
		{code:'340311',name:'郊  区'},
...
var town341300 = [
		...
		{code:'341302',name:'墉桥区'},
		{code:'341321',name:'砀山县'},
		{code:'341322',name:'萧  县'},
		{code:'341323',name:'灵璧县'},
		{code:'341324',name:'泗  县'}];
		//宿州市 ok_zhangjing;
var town341400 = [
		...
		{code:'341424',name:'和  县'}];
		//巢湖市 ok_zhangjing;
var town341500 = [
		
		{code:'341502',name:'金安区'},
		{code:'341503',name:'裕安区'},
		{code:'341521',name:'寿  县'},
...
var town350200 = [
		...
		{code:'350202',name:'鼓浪屿区'},
		{code:'350203',name:'思明区'},
		{code:'350204',name:'开元区'},
		{code:'350205',name:'杏林区'},
...
var town371700 = [
		...
		{code:'371721',name:'曹  县'},
		{code:'371722',name:'单  县'},
...
var town410200 = [
		...
		{code:'410205',name:'南关区'},
		{code:'410211',name:'郊  区'},
		{code:'410221',name:'杞  县'},
...
var town410400 = [
		...
		{code:'410422',name:'叶  县'},
		{code:'410423',name:'鲁山县'},
		{code:'410425',name:'郏  县'},
...
var town410600 = [
		...
		{code:'410611',name:'郊  区'},
		{code:'410621',name:'浚  县'},
		{code:'410622',name:'淇  县'}];
		//鹤壁市 ok_zhangjing;
var town410700 = [
	
		{code:'410702',name:'红旗区'},
		{code:'410703',name:'新华区'},
		{code:'410704',name:'北站区'},
		{code:'410711',name:'郊  区'},
...
var town410900 = [
		...
		{code:'410902',name:'市  区'},
		{code:'410922',name:'清丰县'},
		{code:'410923',name:'南乐县'},
		{code:'410926',name:'范  县'},
...
var town411100 = [
		...
		{code:'411123',name:'郾城县'}];
		//漯河市 ok_zhangjing;
var town411200 = [
		
		{code:'411202',name:'湖滨区'},
		{code:'411221',name:'渑池县'},
		{code:'411222',name:'陕  县'},
...
var town430400 = [
		...
		{code:'430402',name:'江东区'},
		{code:'430403',name:'城南区'},
		{code:'430404',name:'城北区'},
		//{code:'430405',name:'珠晖区'},
		//{code:'430406',name:'雁峰区'},
		//{code:'430407',name:'石鼓区'},
		//{code:'430408',name:'蒸湘区'},
		{code:'430411',name:'郊  区'},
...
var town433100 = [
		...
		//湘西土家族苗族自治州 ok_zhangjing;
var town440100 = [
		
		{code:'440102',name:'东山区'},
		{code:'440103',name:'荔湾区'},
		{code:'440104',name:'越秀区'},
		{code:'440105',name:'海珠区'},
		{code:'440106',name:'天河区'},
		{code:'440107',name:'芳村区'},
...
var town440400 = [
		...
		{code:'440402',name:'斗门县'}];
		//珠海市 ok_zhangjing;
var town440500 = [
		
		{code:'440506',name:'达濠区'},
		{code:'440507',name:'龙湖区'},
		{code:'440508',name:'金园区'},
		{code:'440509',name:'升平区'},
		{code:'440510',name:'河浦区'},
		...
		{code:'440582',name:'潮阳市'},
		{code:'440583',name:'澄海市'}];
		//汕头市 ok_zhangjing;
var town440600 = [
		
		{code:'440602',name:'城  区'},
		{code:'440603',name:'石湾区'},
		//{code:'440604',name:'禅城区'},
		//{code:'440605',name:'南海区'},
		//{code:'440606',name:'顺德区'},
		//{code:'440607',name:'三水区'},
		//{code:'440608',name:'高明区'},
		{code:'440681',name:'顺德市'},
		{code:'440682',name:'南海市'},
		{code:'440683',name:'三水市'},
		{code:'440684',name:'高明市'}];
		//佛山市 ok_zhangjing;
var town440700 = [
...
var town441300 = [
		...
		{code:'441381',name:'惠阳市'}];
		//惠州市 ok_zhangjing;
var town441400 = [
		
		{code:'441402',name:'梅江区'},
		{code:'441421',name:'梅  县'},
...
var town450100 = [
		...
		{code:'450103',name:'新城区'},
		{code:'450104',name:'城北区'},
		{code:'450105',name:'江南区'},
		{code:'450106',name:'永新区'},
		//{code:'450107',name:'西乡塘区'},
		//{code:'450108',name:'良庆区'},
		//{code:'450109',name:'邕宁区'},
		{code:'450111',name:'市郊区'},
		{code:'450121',name:'邕宁县'},
...
var town450400 = [
		...
		{code:'450411',name:'市郊区'},
		{code:'450421',name:'苍梧县'},
		{code:'450422',name:'藤  县'},
...
var town450700 = [
		...
		{code:'450721',name:'浦北县'},
		{code:'450722',name:'灵山县'}];
		//钦州市 ok_zhangjing;
var town450800 = [
...
var town452100 = [
		{code:'452101',name:'凭祥市'},
		{code:'452122',name:'横  县'},
		{code:'452123',name:'宾阳县'},
		{code:'452124',name:'上林县'},
		{code:'452126',name:'隆安县'},
		{code:'452127',name:'马山县'},
		{code:'452128',name:'扶绥县'},
		{code:'452129',name:'崇左县'},
		{code:'452130',name:'大新县'},
		{code:'452131',name:'天等县'},
		{code:'452132',name:'宁明县'},
		{code:'452133',name:'龙州县'}];
		//南宁地区 ok_zhangjing;
		
var town452200 = [
		
		{code:'452201',name:'合山市'},
		{code:'452223',name:'鹿寨县'},
		{code:'452224',name:'象州县'},
		{code:'452225',name:'武宣县'},
		{code:'452226',name:'来宾县'},
		{code:'452227',name:'融安县'},
		{code:'452228',name:'三江侗族自治县'},
		{code:'452229',name:'融水苗族自治县'},
		{code:'452230',name:'金秀瑶族自治县'},
		{code:'452231',name:'忻城县'}];
		//柳州地区 ok_zhangjing;

var town452400 = [
		
		{code:'452402',name:'贺州市'},
		{code:'452424',name:'昭平县'},
		{code:'452427',name:'钟山县'},
		{code:'452428',name:'富川瑶族自治县'}];
		//贺州地区 ok_zhangjing;

var town452600 = [
		
		{code:'452601',name:'百色市'},
		//{code:'451021',name:'田阳县'},
		{code:'452622',name:'田阳县'},
		{code:'452623',name:'田东县'},
		{code:'452624',name:'平果县'},
		{code:'452625',name:'德保县'},
		{code:'452626',name:'靖西县'},
		{code:'452627',name:'那坡县'},
		{code:'452628',name:'凌云县'},
		{code:'451029',name:'乐业县'},
		{code:'452630',name:'田林县'},
		{code:'452631',name:'隆林各族自治县'},
		{code:'452632',name:'西林县'}];
		//百色地区 ok_zhangjing;

var town452700 = [
		
		{code:'452701',name:'河池市'},
		{code:'452702',name:'宜州市'},
		{code:'452723',name:'罗城仫佬族自治县'},
		{code:'452724',name:'环江毛南族自治县'},
		{code:'452725',name:'南丹县'},
		{code:'452726',name:'天峨县'},
		{code:'452727',name:'凤山县'},
		{code:'452728',name:'东兰县'},
		{code:'452729',name:'巴马瑶族自治县'},
		{code:'452730',name:'都安瑶族自治县'},
		{code:'452731',name:'大化瑶族自治县'}];
		//河池地区 ok_zhangjing;

var town469000 = [
		{code:'460001',name:'通什市'},
		{code:'460002',name:'琼海市'},
		{code:'460003',name:'儋州市'},
		{code:'460004',name:'琼山市'},
		{code:'460005',name:'文昌市'},
		{code:'460006',name:'万宁市'},
		{code:'460007',name:'东方市'},
		{code:'460025',name:'定安县'},
		{code:'460026',name:'屯昌县'},
		{code:'460027',name:'澄迈县'},
		{code:'460028',name:'临高县'},
		{code:'460030',name:'白沙黎族自治县'},
		{code:'460031',name:'昌江黎族自治县'},
		{code:'460033',name:'乐东黎族自治县'},
		{code:'460034',name:'陵水黎族自治县'},
		{code:'460035',name:'保亭黎族苗族自治县'},
		{code:'460036',name:'琼中黎族苗族自治县'},
		{code:'460037',name:'西沙群岛'},
		{code:'460038',name:'南沙群岛'},
		{code:'460039',name:'中沙群岛的岛礁及其海域'}];
		//海南省 ok_zhangjing;

var town460100 = [
		
		{code:'460102',name:'振东区'},
		{code:'460103',name:'新华区'},
		{code:'460104',name:'秀英区'}];
		//海口市 ok_zhangjing;
...
var town500300 = [
		...
		{code:'500381',name:'江津市'},
		{code:'500382',name:'合川市'},
		{code:'500383',name:'永川市'},
		{code:'500384',name:'南川市'}];
		//市 ok_zhangjing;
...
var town510100 = [
		...
		{code:'510123',name:'温江县'},
		{code:'510124',name:'郫  县'},
		{code:'510125',name:'新都县'},
...
var town511500 = [
		...
		{code:'511525',name:'高  县'},
		{code:'511526',name:'珙  县'},
...
var town513200 = [
		...
		{code:'513222',name:'理  县'},
		{code:'513223',name:'茂  县'},
...
var town522700 = [
		...
		//黔南布依族苗族自治州 ok_zhangjing;

var town529800 = [
		{code:'522701',name:'贵州直报单位'}];
		//贵州直报单位 ok_zhangjing;
...
var town532100 = [
		...
		{code:'532101',name:'昭通市'},
		{code:'532122',name:'鲁甸县'},
		{code:'532123',name:'巧家县'},
		{code:'532124',name:'盐津县'},
		{code:'532125',name:'大关县'},
		{code:'532126',name:'永善县'},
		{code:'532127',name:'绥江县'},
		{code:'532128',name:'镇雄县'},
		{code:'532129',name:'彝良县'},
		{code:'532130',name:'威信县'},
		{code:'532131',name:'水富县'}];
		//昭通地区 ok_zhangjing;
var town532300 = [
...
var town532600 = [
		...
		//文山壮族苗族自治州 ok_zhangjing;
		
		
var town532700 = [
		
		{code:'532701',name:'思茅市'},
		{code:'532722',name:'普洱哈尼族彝族自治县'},
		{code:'532723',name:'墨江哈尼族自治县'},
		{code:'532724',name:'景东彝族自治县'},
		{code:'532725',name:'景谷傣族彝族自治县'},
		{code:'532726',name:'镇沅彝族哈尼族拉祜族自治县'},
		{code:'532727',name:'江城哈尼族彝族自治县'},
		{code:'532728',name:'孟连傣族拉祜族佤族自治县'},
		{code:'532729',name:'澜沧拉祜族自治县'},
		{code:'532730',name:'西盟佤族自治县'}];
		//思茅地区 ok_zhangjing;
		
var town532800 = [
		{code:'532801',name:'景洪市'}];
		//西双版纳傣族自治州 ok_zhangjing;
var town532900 = [
...
var town533100 = [
		...
		//德宏傣族景颇族自治州 ok_zhangjing;
		
var town533200 = [
		{code:'533221',name:'丽江纳西族自治县'},
		{code:'533222',name:'永胜县'},
		{code:'533223',name:'华坪县'},
		{code:'533224',name:'宁蒗彝族自治县'}];
		//丽江地区 ok_zhangjing;
...
var town533300 = [
		...
		//怒江傈僳族自治州 ok_zhangjing;
var town533400 = [
		{code:'533421',name:'中甸县'},
		{code:'533422',name:'德钦县'},
		{code:'533423',name:'维西傈僳族自治县'}];
		//迪庆藏族自治州 ok_zhangjing;
		
var town533500 = [
		{code:'533521',name:'临沧县'},
		{code:'533522',name:'凤庆县'},
		{code:'533523',name:'云  县'},
		{code:'533524',name:'永德县'},
		{code:'533525',name:'镇康县'},
		{code:'533526',name:'双江拉祜族佤族布朗族傣族自'},
		{code:'533527',name:'耿马傣族佤族自治县'},
		{code:'533528',name:'沧源佤族自治县'}];
		//临沧地区 ok_zhangjing;
...
var town610100 = [
		...
		{code:'610116',name:'长安县'},
		{code:'610122',name:'蓝田县'},
		{code:'610124',name:'周至县'},
		{code:'610125',name:'户  县'},
...
var town610400 = [
		...
		{code:'610424',name:'乾  县'},
		{code:'610425',name:'礼泉县'},
		{code:'610426',name:'永寿县'},
		{code:'610427',name:'彬  县'},
...
var town610700 = [
		...
		{code:'610723',name:'洋  县'},
		{code:'610724',name:'西乡县'},
		{code:'610725',name:'勉  县'},
...
var town612500 = [
		...
		{code:'612501',name:'商州市'},
		{code:'612522',name:'洛南县'},
		{code:'612523',name:'丹凤县'},
		{code:'612524',name:'商南县'},
		{code:'612525',name:'山阳县'},
		{code:'612526',name:'镇安县'},
		{code:'612527',name:'柞水县'}];
		//商洛地区 ok_zhangjing;
var town620100 = [
...
var town622100 = [
		...
		{code:'622101',name:'玉门市'},
		{code:'622102',name:'酒泉市'},
		{code:'622103',name:'敦煌市'},
		{code:'622123',name:'金塔县'},
		{code:'622124',name:'肃北蒙古族自治县'},
		{code:'622125',name:'阿克塞哈萨克族自治县'},
		{code:'622126',name:'安西县'}];
		//酒泉地区 ok_zhangjing;
		
var town622200 = [
		
		{code:'622201',name:'甘张掖市'},
		{code:'622222',name:'肃南裕固族自治县'},
		{code:'622223',name:'民乐县'},
		{code:'622224',name:'临泽县'},
		{code:'622225',name:'高台县'},
		{code:'622226',name:'山丹县'}];
		//张掖地区 ok_zhangjing;
		
var town622300 = [
		
		{code:'622301',name:'武威市'},
		{code:'622322',name:'民勤县'},
		{code:'622323',name:'古浪县'},
		{code:'622326',name:'天祝藏族自治县'}];
		//武威地区 ok_zhangjing;
		
var town622400 = [
		
		{code:'622421',name:'定西县'},
		{code:'622424',name:'通渭县'},
		{code:'622425',name:'陇西县'},
		{code:'622426',name:'渭源县'},
		{code:'622427',name:'临洮县'},
		{code:'622428',name:'漳  县'},
		{code:'622429',name:'岷  县'}];
		//定西地区 ok_zhangjing;
		
var town622600 = [
		
		{code:'622621',name:'武都县'},
		{code:'622623',name:'宕昌县'},
		{code:'622624',name:'成  县'},
		{code:'622625',name:'康  县'},
		{code:'622626',name:'文  县'},
		{code:'622627',name:'西和县'},
		{code:'622628',name:'礼  县'},
		{code:'622629',name:'两当县'},
		{code:'622630',name:'徽  县'}];
		//陇南地区 ok_zhangjing;

		
var town622700 = [
		
		{code:'622701',name:'平凉市'},
		{code:'622722',name:'泾川县'},
		{code:'622723',name:'灵台县'},
		{code:'622724',name:'崇信县'},
		{code:'622725',name:'华亭县'},
		{code:'622726',name:'庄浪县'},
		{code:'622727',name:'静宁县'}];
		//平凉地区 ok_zhangjing;

var town622800 = [
		
		{code:'622801',name:'西峰市'},
		{code:'622821',name:'庆阳县'},
		{code:'622822',name:'环  县'},
		{code:'622823',name:'华池县'},
		{code:'622824',name:'合水县'},
		{code:'622825',name:'正宁县'},
		{code:'622826',name:'宁  县'},
		{code:'622827',name:'镇原县'}];
		//庆阳地区 ok_zhangjing;
...
var town632800 = [
		...
		{code:'632824',name:'茫崖'},
		{code:'632825',name:'大柴旦'},
		{code:'632827',name:'冷湖'}];
		//海西蒙古族藏族自治州 ok_zhangjing;
var town640100 = [
		
		{code:'640102',name:'城  区'},
		{code:'640103',name:'新城区'},
		//{code:'640104',name:'兴庆区'},
		//{code:'640105',name:'西夏区'},
		//{code:'640106',name:'金凤区'},
		{code:'640111',name:'郊  区'},
...
var town640200 = [
		...
		{code:'640203',name:'石嘴山区'},
		{code:'640204',name:'石炭井区'},
		{code:'640221',name:'平罗县'},
		{code:'640222',name:'陶乐县'},
		{code:'640223',name:'惠农县'}];
		//石嘴山市 ok_zhangjing;
var town640300 = [
		
		{code:'640302',name:'利通区'},
		{code:'640321',name:'中卫县'},
		{code:'640322',name:'中宁县'},
		{code:'640302',name:'利通区'},
		{code:'640323',name:'盐池县'},
		{code:'640324',name:'同心县'},
		{code:'640381',name:'青铜峡市'},
		{code:'640382',name:'灵武市'}];
		//吴忠市 ok_zhangjing;
var town642200 = [
		
		{code:'642221',name:'固原县'},
		{code:'642222',name:'海原县'},
		{code:'642223',name:'西吉县'},
		{code:'642224',name:'隆德县'},
		{code:'642225',name:'泾源县'},
		{code:'642226',name:'彭阳县'}];
		//固原地区 ok_zhangjing;
//var town640500 = [
...
var town650100 = [
		...
		{code:'650105',name:'南泉区'},
		{code:'650106',name:'头屯河区'},
		{code:'650107',name:'南泉区'},
		{code:'650108',name:'东山区'},
...
var town654100 = [
		{code:'654101',name:'伊宁市'},
		{code:'654121',name:'伊宁县'},
		{code:'654122',name:'察布查尔锡伯自治县'},
		{code:'654123',name:'霍城县'},
		{code:'654124',name:'巩留县'},
		{code:'654125',name:'新源县'},
		{code:'654126',name:'昭苏县'},
		{code:'654127',name:'特克斯县'},
		{code:'654128',name:'尼勒克县'}];
		//伊犁地区 ok_zhangjing;
